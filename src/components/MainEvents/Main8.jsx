...
const data = [
  ...
  "「……我……」",
  "發光的藍色晶礦成簇地鑲在了濡濕的暗色肉壁上，隨著細小的氣流微微起伏著。可以確定你們應該是被一隻難以想像的巨獸一口吞入了腹中，牠體內的空間大得出奇，你們的船隻航行得毫不費力，這怪物似乎仗著體型龐大就什麼都想來上一口，一些破敗的殘骸在下方的水面飄著。",
  "「錯誤……孽……」",
